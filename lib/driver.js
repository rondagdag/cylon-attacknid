...
Driver.prototype.moveforward = function() {
  this.bluetoothconnection.sendCommand(this.commandData.forward);
};

Driver.prototype.movebackward = function() {
  this.bluetoothconnection.sendCommand(this.commandData.backward);
};

Driver.prototype.turnleft = function() {
  this.bluetoothconnection.sendCommand(this.commandData.left);
};

Driver.prototype.turnright = function() {
  this.bluetoothconnection.sendCommand(this.commandData.right);
};

Driver.prototype.up = function() {
  this.bluetoothconnection.sendCommand(this.commandData.up);
};

Driver.prototype.down = function() {
  this.bluetoothconnection.sendCommand(this.commandData.down);
};

Driver.prototype.fire = function() {
  this.bluetoothconnection.sendCommand(this.commandData.fire);
};

Driver.prototype.light = function() {
  this.bluetoothconnection.sendCommand(this.commandData.light);
};
